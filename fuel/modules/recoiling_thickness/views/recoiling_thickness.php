...
<div id="main_top_panel">
	<h2 class="ico ico_recoiling_thickness">Recoiling Thickness</h2>
</div>

<?php include_once(RECOILING_THICKNESS_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(RECOILING_THICKNESS_PATH.'views/_blocks/layout.php');?>		
