...
<div id="main_top_panel">
	<h2 class="ico ico_rate_details_thickness"><?=lang('module_rate_details_thickness')?></h2>
</div>

<?php include_once(RATE_DETAILS_THICKNESS_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(RATE_DETAILS_THICKNESS_PATH.'views/_blocks/layout.php');?>		
