...
function pullFolders(selectedItem) {
	...
	$.post('<?php echo fuel_url("rate_details_weight/coil"); ?>',
...
<div id="main_top_panel">
	<h2 class="ico ico_rate_details_weight"><?=lang('module_rate_details_weight')?></h2>
</div>

<?php include_once(RATE_DETAILS_WEIGHT_PATH.'views/_blocks/toolbar.php');?>		
<?php include_once(RATE_DETAILS_WEIGHT_PATH.'views/_blocks/layout.php');?>		
