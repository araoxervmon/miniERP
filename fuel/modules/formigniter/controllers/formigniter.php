...
class Formigniter extends Fuel_base_controller
{
	public $nav_selected =  'formigniter';
	public $view_location = 'formigniter';
	private $data;
...
?>';
 ...
 PRIMARY KEY (id)
	...
	private function build_page($page, $title,$data = null)
	{
		...
		$data['page'] = $page;
		$this->load->vars($data);
		//$this->load->view('formigniter');
		$this->_render('formigniter');
	}
