...
$config['nav']['Reports'] = array('stock_report' => ' Stock Report ',
										'customer_inward' => 'Customer Inward',
										'customer_billing' => 'Customer Billing',
										'customer_outward' => 'Customer Outward',
										'customer_summary' => 'Customer Summary',
										'factory_material' => 'Factory Material ',
										//'partywise_report_holding' => 'Partywise Average ',
										'total_average' => 'Total Partywise ',
										'average_party' => 'Partywise Average',
);
...
$config['fuel_javascript'] = array('xervmon-core-default',
	//'angular/angular.min.js',
	//'angular/angular-ui.min.js',
	//'angular/angular-ui-ieshiv.min.js',
	//'arbor/arbor.js',
	//'arbor/graphics.js',
	//'arbor/renderer.js',
	'bootstrap/jquery.jtable.min.js',
	'bootstrap/amberjack.pack.js',
	'bootstrap/aws_parent.js',
	...
	'bootstrap/datavisualization_parent.js',
	'bootstrap/list.min.js',
	'bootstrap/list.fuzzySearch.min.js',
	'bootstrap/list.paging.min.js',
	'jquery/plugins/validation/jquery.validationEngine-en.js',
	'jquery/plugins/validation/jquery.validationEngine.js',
	'nvd3/lib/d3.v2.min',
